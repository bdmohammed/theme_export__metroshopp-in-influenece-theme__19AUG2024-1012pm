    ...
    class PasswordLogin extends HTMLElement {
      constructor() {
        ...
        this.loginButton = this.querySelector(
          '[data-armada-selector="login_with_password"]',
        );
        this.returnButton = this.querySelector(
          '[data-armada-selector="return_to_signup"]',
        );
        this.loginPage = this.querySelector(
          '[data-armada-selector="login_content"]',
        );
        this.signUpPage = this.querySelector(
          '[data-armada-selector="signup_content"]',
        );
      }
      ...
      setEventListeners() {
        ...
        window.eight.armada.elementRegistry.register({
          key: "password-login",
          assetPath: "/assets/component-password-login.min.js",
        });
      }
