(window.lazySizesT4Config = window.lazySizesT4Config || {}),
          ...
          if (e.detail.instance == n) {
            ...
            if (!e.defaultPrevented) {
              ...
              (t = d.getAttribute('data-link')) && a(t, !0),
                ...
                (o = d.getAttribute('data-bg')) &&
                  ((e.detail.firesLoad = !0),
                  (s = function () {
                    (d.style.backgroundImage =
                      'url(' + (r.test(o) ? JSON.stringify(o) : o) + ')'),
      ...
      function (e) {
        ...
        if (!(e.defaultPrevented || !n || n.indexOf('_1x1.') < 0 || a)) {
          var i,
            ...
            l = n,
            n = '',
            d = (i = t.hasAttribute('data-widths')
      ...
      addEventListener('lazybeforeunveil', function (e) {
        ...
        t.documentElement.addEventListener('lazybeforesizes', function (e) {
          !e.defaultPrevented &&
            e.target._lazybgset &&
            e.detail.instance == n &&
            (e.detail.width = (function (e) {
              var t = n.gW(e, e.parentNode);
              return (
                (!e._lazySizesT4Width || t > e._lazySizesT4Width) &&
                  (e._lazySizesT4Width = t),
                e._lazySizesT4Width
              );
            })(e.target._lazybgset));
        });
  ...
  (function (e, t) {
    ...
    function a(e) {
      var t;
      (t = e.match(A))
        ? (this.urls[t[1]] = v.map[t[2]] || t[2])
        : (this.urls.include = v.map[e] || e);
    }
    function i(e) {
      var t, n, i;
      return (
      ...
      return (
        a.condition &&
          (!(function () {
            var e;
            p ||
              (g || (g = t.querySelector(v.contentElement)),
              g
                ? ((e = (
                    S(g, ':after').getPropertyValue('content') || 'none'
                  ).replace(w, '')),
                  (p = {}),
                  e && (p[e] = 1),
                  (e = (
                    S(g, ':before').getPropertyValue('content') || 'none'
                  ).replace(w, '')) && (p[e] = 1))
                : (p = {}));
          })(),
          p[a.name]
            ...
            ? (i = (matchMedia(a.condition) || {}).matches)
            : 'function' == typeof a.condition && (i = a.condition(n, a))),
        i
      );
    }
    function s(e) {
      ...
      if (a && a.candidates)
        for (
          t = 0;
          t < a.candidates.length && ((n = a.candidates[t]), !r(e, n));
          t++
        );
      return (n && n != a.current) || (n = null), n;
    }
    function o(e, n, a) {
      if (h[e]) a && (!0 === h[e] ? setTimeout(a) : h[e].push(a));
      else {
    ...
    function c(e, t) {
      ...
      if (n.fire(e, 'lazyincludeload', y).defaultPrevented) T.d();
      else {
        if (
          ((c = function () {
            i && r && !s && a();
          ...
          (a = function () {
            ...
            (t.modules = r),
              f &&
                f.modules &&
                (f.modules.forEach(d, v),
                (f.modules = null),
                y.resetHTML &&
                  null == y.content &&
                  t.initial &&
                  t.initial.saved &&
                  (y.content = t.initial.content)),
              r.forEach(l, v),
              ...
              y.insert &&
                ...
                !a.defaultPrevented &&
                null != y.content &&
                y.content != e.innerHTML &&
                (e.innerHTML = y.content),
              T.d(),
              r.forEach(u, v),
              setTimeout(function () {
          ...
          var v = function () {
            (r = Array.prototype.slice.call(arguments)), c();
          };
          t.urls.amd
            ? (function (e, t) {
    ...
    function f(e) {
      ...
      if (
        (function (e) {
          var t,
            a = e.getAttribute('data-set4surl') || '';
          ...
          else var r = (e.getAttribute('data-rendert4s') || '') + a;
          var s,
            o = e.lazyInclude;
          return (
            (o && o.str == r && !v.allowReload) ||
              ((s = {
                saved: !1,
                content: null,
              }),
    ...
    if (t.getElementsByClassName) {
      var y,
        ...
        w = /['"]/g,
        L = t.documentElement,
        C = t.getElementsByClassName('lazyconditionalinclude'),
        S = function (t, n) {
        ...
        T = (function () {
          var e = 2,
            ...
            i = (function () {
              ...
              return function () {
                clearTimeout(e), (e = setTimeout(n, 999));
              };
            })();
          return {
            q: function (r) {
              ...
              s && (n++, (e = 3)),
                t > e ? a[s ? 'unshift' : 'push'](r) : f(r) && (t++, i());
            },
            d: function () {
              if ((t && t--, n > 0 && (--n || (e = 2)), !(t > e))) {
                for (; a.length; )
                  if (f(a.shift())) {
                    t++;
                    break;
  ...
  (function (e, t) {
    ...
    function a(t, n, a) {
      ...
      s = function (e, n) {
        ...
        if (i) {
          ...
          else if (u.test(i)) i = parseFloat(i);
          else if ('function' == typeof o[e]) i = o[e](t, i);
          else if (g.test(i))
            try {
              i = JSON.parse(i);
            } catch (e) {}
          ...
          e in o && 'function' != typeof o[e] && !a[e]
            ? (a[e] = o[e])
            : n && 'function' == typeof o[e] && (a[e] = o[e](t, i));
      };
      for (i in o) s(i);
      return (
        n.replace(v, function (e, t) {
          t in a || s(t, !0);
        }),
        a
      );
    ...
    function i(e, n, a) {
      ...
      if (e) {
        if ('container' === n.ratio) {
          for (i = l.scrollWidth, r = l.scrollHeight; !((i && r) || l === t); )
            (i = (l = l.parentNode).scrollWidth), (r = l.scrollHeight);
        ...
        ((e = (function (e, t) {
          ...
          return (
            (n.srcset = []),
            t.absUrl && (z.setAttribute('href', e), (e = z.href)),
              ...
              var i = t.widthmap[a] || a,
                ...
                l = {
                  u: e
                    ...
                    .replace(
                      y,
                      r ? (s ? Math.round(a * r) : Math.round(a / r)) : ''
                    ),
                  w: a,
                };
              n.push(l), n.srcset.push((l.c = l.u + ' ' + a + 'w'));
            }),
            n
          );
        })(e, n)).isPicture = n.isPicture),
          h && 'IMG' == a.nodeName.toUpperCase()
            ? a.removeAttribute(s.srcsetAttr)
            : a.setAttribute(s.srcsetAttr, e.srcset.join(', ')),
    ...
    function r(e) {
      var t =
        e.getAttribute(e.getAttribute('data-srcattr') || o.srcAttr) ||
        e.getAttribute(s.srcsetAttr) ||
    ...
    var s,
      ...
      h = 'srcset' in m && !('sizes' in m),
      b = !!e.HTMLPictureElement && !h;
    !(function () {
      var e,
        t = {
          prefix: '',
          ...
          if (e.detail.instance == n) {
            ...
            if (
              ...
              e.detail.dataAttr &&
                !e.defaultPrevented &&
                !o.disabled &&
                (z = t.getAttribute(s.sizesAttr) || t.getAttribute('sizes')) &&
                p.test(z))
            ) {
              if (
                ((l = r(t)),
                ...
                for (
                  y = 0, v = (c = u.getElementsByTagName('source')).length;
                  y < v;
                  y++
                )
                  (h || f.test((g = r(c[y])))) &&
                    (i(g, a(c[y], g, d), c[y]), (E = !0));
              h || f.test(l)
                ? (i(l, d, t), (E = !0))
                : E &&
                  (((w = []).srcset = []),
      ...
      var a = function (e, t) {
        ...
        i = function (e, t) {
          ...
          return (
            !e._lazyrias &&
              n.pWS &&
              (a = n.pWS(e.getAttribute(s.srcsetAttr || ''))).length &&
        ...
        r = function (o) {
          if (o.detail.instance == n) {
            var d,
              u = o.target;
            h || !(e.respimage || e.picturefill || l.pf)
              ? ('_lazyrias' in u || (o.detail.dataAttr && i(u, !0))) &&
                (d = (function (t, r) {
                  var s, o, l, d, u, c;
                  if ((u = t._lazyrias).isPicture && e.matchMedia)
                    for (
                      o = 0,
                        l = (s = t.parentNode.getElementsByTagName('source'))
                          .length;
                      o < l;
                      o++
                    )
                ...
                (d.cached = !0),
                n.rAF(function () {
                  u.setAttribute(s.srcAttr, d.u), u.setAttribute('src', d.u);
                }))
              : t.removeEventListener('lazybeforesizes', r);
          }
        };
      return (
        b ? (r = function () {}) : addEventListener('lazybeforesizes', r), r
      );
    })();
  }),
  (function (e, t) {
      ...
      var r = t.documentElement,
        ...
        w = (function () {
          var e,
            ...
            s = function () {
              var t = r;
              for (r = a.length ? i : a, e = !0, n = !1; t.length; )
                t.shift()();
              e = !1;
            },
            o = function (a, i) {
          ...
          var s,
                  ...
                  if (m[n] && !m[n]._lazyRace)
                    if (!W || (a.prematureUnveil && a.prematureUnveil(m[n])))
                      ...
                      (F = o.bottom) >= c &&
                        ...
                        (F || P || x || M) &&
                        (i.loadHidden || I(m[n])) &&
                        ((f && j < 3 && !y && (E < 3 || H < 4)) || $(m[n], u)))
                    ) {
                      if ((K(m[n]), (d = !0), j > 9)) break;
                    } else
                      !d &&
                        f &&
                        !l &&
            ...
            Q = L(function (e, t, n, a, r) {
              ...
              (f = h(e, 'lazybeforeunveil', t)).defaultPrevented ||
                ...
                p(e, i.loadingClass),
                g && (clearTimeout(y), (y = l(B, 2500)), m(e, X, !0)),
            ...
            Z = function () {
              3 == i.loadMode && (i.loadMode = 2), Y();
            },
            ee = function () {
              f ||
                (n.now() - S < 999
                  ? l(ee, 999)
                  : ((f = !0), (i.loadMode = 3), J(), o('scroll', Z, !0)));
            };
          return {
            _: function () {
              (S = n.now()),
                ...
                /d$|^c/.test(t.readyState)
                  ...
                  : (o('load', ee),
                    ...
                    l(ee, 2e4)),
                a.elements.length ? (D(), w._lsFlush()) : J();
            },
            checkElems: J,
            unveil: K,
            _aLSL: Z,
        ...
        T = (function () {
          ...
          return {
            _: function () {
              (e = t.getElementsByClassName(i.autosizesClass)), o('resize', r);
            },
            checkElems: r,
            updateElem: a,
          };
