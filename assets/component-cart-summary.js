...
/******/ (() => {
  ...
  (() => {
    "use strict";
    /* harmony import */ var _weareeight_armada_dist_utils_debounce__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(273);
    /* harmony import */ var _weareeight_armada_dist_utils_debounce__WEBPACK_IMPORTED_MODULE_0___default =
      /*#__PURE__*/ __webpack_require__.n(
        _weareeight_armada_dist_utils_debounce__WEBPACK_IMPORTED_MODULE_0__,
      );
    ...
    class CartSummary extends HTMLElement {
      ...
      handleLoaded() {
        ...
        _weareeight_armada_dist_utils_debounce__WEBPACK_IMPORTED_MODULE_0__.debounce)(
          this.handleResize,
          250,
        );
        ...
        document.addEventListener("ARMADA:SECTION:FETCH", (e) =>
          this.handleSectionFetch(e.detail),
        );
        this.init();

        window.eight.armada.elementRegistry.register({
          key: "component-cart-summary",
          assetPath: "/assets/component-cart-summary.min.js",
        });
      }

      init() {
        if (
          this.cartMainInner?.offsetHeight > window.innerHeight ||
      ...
      handleStickySummary() {
        ...
        if (!this.isMobile()) {
          if (this.emptyEl)
            this.emptyEl
              .querySelector('[data-armada-selector="regular-price-container"]')
              .classList.add("flex");
        }

        const summaryObserverCallback = (
          elementsToObserve,
          cartSummaryObserver,
        ) => {
          if (!elementsToObserve[0].isIntersecting) {
            ...
            const elementRect =
              elementsToObserve[0].target.getBoundingClientRect();
        ...
        const staticSummary = this.isMobile()
          ...
          : document.querySelector(
              '[data-armada-selector="cart-summary-static-top"]',
            );

        let heightForMargin = staticSummary ? staticSummary.offsetHeight : 60;
        heightForMargin = window.Shopify.designMode
          ? heightForMargin * 2
          : heightForMargin;

        const cartSummaryObserver = new IntersectionObserver(
          summaryObserverCallback,
          {
            root: null,
      ...
      get checkoutButton() {
        return this.querySelector(
          '[data-armada-selector="cart-summary-static-bottom"] [data-armada-selector="checkout-button"]',
        );
      }
      ...
      get stickySummary() {
        return this.querySelector(
          '[data-armada-selector="cart-summary-sticky"]',
        );
      }
