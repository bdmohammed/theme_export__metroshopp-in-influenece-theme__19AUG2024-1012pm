  ...
  (() => {
    ...
    class ShopTheLook extends HTMLElement {
      constructor() {
        ...
        this.mainImageOverlay = this.querySelector(
      ...
      init() {
        ...
        window.eight.armada.elementRegistry.register({
          key: "shop-the-look",
          assetPath: "/assets/component-shop-the-look.min.js",
        });
      ...
      handleMarkerClick() {
        ...
        this.mainImageOverlay.addEventListener(
          "click",
          this.handleClose.bind(this),
        );
      ...
      showProduct(marker) {
        ...
        const inactiveMarkers = this.querySelectorAll(
          `[data-armada-marker]:not([data-armada-image-id="${clickedMarker}"])`,
        );
        ...
        const inactiveImgs = this.querySelectorAll(
          `[data-armada-product-img]:not([data-img-id="${productImgId}"])`,
        );
      ...
      handleBlockSelect(e) {
        const getActiveMarker = this.querySelector(
          `[data-stl-block-id="${e.detail.blockId}"]`,
        );
