...
/******/ (() => {
  ...
  (() => {
    ...
    class ProductThumbnailGallery extends HTMLElement {
      constructor() {
        super();
        this.thumbnailSlider = this.querySelector(
          '[data-armada-selector="product-thumbnail-slider"]',
        );
        this.sliderContainer = this.querySelector(
          '[data-armada-selector="product-thumbnail-slider-container"]',
        );
        this.mediaContainer = this.querySelector(
        ...
        this.sliderAnimiationElement = this.querySelector(
          '[data-armada-selector="product-thumbnail-animate-target"]',
        );
        this.activeThumbnailClasses = [
          "lg:after:absolute",
          "lg:after:h-2",
          "lg:after:left-0",
          "lg:after:right-0",
      ...
      init() {
        this.thumbnailSlider.addEventListener("click", (e) =>
          this.setMedia(this.mediaContainer, this.getMediaId(e.target)),
        );
        this.thumbnailSlider.addEventListener("click", (e) =>
          this.setActiveThumbnail(
            this.getMediaId(e.target),
            this.thumbnailSlider,
            this.activeThumbnailClasses,
          ),
        );
        this.thumbnailSlider.addEventListener("keyup", (e) =>
          this.keyUpHandler(e),
        );

        document.addEventListener("ARMADA:VARIANT:CHANGE", (e) =>
          this.handleVariantChange(e),
        );
        window.eight.armada.elementRegistry.register({
          key: "product-thumbnail-gallery",
          assetPath: "/assets/component-product-thumbnail-gallery.min.js",
        });
      ...
      handleVariantChange(e) {
        ...
        this.setActiveThumbnail(
          this.getMediaIdFromVariant(e.detail.variant, this.featuredImageId),
          this.thumbnailSlider,
          this.activeThumbnailClasses,
        );
      }
      ...
      setMediaOnVariantChange(
        ...
        this.setMedia(
          mediaContainer,
          this.getMediaIdFromVariant(variant, featuredImageId),
          thumbnails,
          activeThumbnailClasses,
        );
      }
      ...
      setMedia(mediaContainer, mediaId) {
        ...
        const media = mediaContainer.querySelector(
      ...
      hideDeselectedMedia(mediaContainer) {
        const deselectedMedia = mediaContainer.querySelector(
      ...
      setActiveThumbnail(mediaId, thumbnails, activeThumbnailClasses) {
        const deselectedThumbnail = thumbnails.querySelector(
          '[data-thumbnail-selected="true"]',
        );
        const selectedThumbnail = thumbnails.querySelector(
          `[data-media-id="${mediaId}"]`,
        );
        ...
        if (
          !deselectedThumbnail ||
          !selectedThumbnail ||
          this.getMediaId(deselectedThumbnail) == mediaId ||
          !mediaId
        )
          return;
      ...
      sliderIsScrollable() {
        return (
          this.thumbnailSlider.offsetHeight > this.sliderContainer.offsetHeight
        );
      }
    }
