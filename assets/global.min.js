...
function(t, e) {
    ...
    function v(t, e) {
        for (var i, n, o, s, r, a, l, u = [], c = 0, h = t.length; c < h; c++)
            ...
            e ? ("none" === i && (u[c] = At.get(n, "display") || null,
            u[c] || (n.style.display = "")),
            "" === n.style.display && Ht(n) && (u[c] = (l = r = s = void 0,
            r = (o = n).ownerDocument,
            a = o.nodeName,
    ...
    function D(t, e, n, o) {
        ...
        r || o)) {
            ...
            if (l)
                ...
                h = 0; h < l; h++)
                    u = a[h],
                    Gt.test(u.type || "") && !At.access(u, "globalEval") && pt.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? pt._evalUrl && !u.noModule && pt._evalUrl(u.src, {
    ...
    function B(t, e, i) {
        var n, o, s = 0, r = B.prefilters.length, a = pt.Deferred().always(function() {
            ...
            if (o)
                return !1;
            for (var e = he || $(), i = Math.max(0, u.startTime + u.duration - e), n = 1 - (i / u.duration || 0), s = 0, r = u.tweens.length; s < r; s++)
                u.tweens[s].run(n);
            return a.notifyWith(t, [u, n, i]),
            n < 1 && r ? i : (r || a.notifyWith(t, [u, 1, 0]),
            a.resolveWith(t, [u]),
            !1)
        }, u = a.promise({
            elem: t,
        ...
        for (!function(t, e) {
            ...
            if (n = B.prefilters[s].call(u, t, c, u.opts))
                return ut(n.stop) && (pt._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)),
                n;
        return pt.map(c, R, u),
    ...
    function Y(t, e, i, n) {
        function o(a) {
            ...
            pt.each(t[a] || [], function(t, a) {
                var u = a(e, i, n);
                return "string" != typeof u || r || s[u] ? r ? !(l = u) : void 0 : (e.dataTypes.unshift(u),
                o(u),
                !1)
            }),
            l
    ...
    pt.extend = pt.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    n = t[e],
                    "__proto__" !== e && r !== n && (u && n && (pt.isPlainObject(n) || (o = Array.isArray(n))) ? (i = r[e],
                    s = o && !Array.isArray(i) ? [] : o || pt.isPlainObject(i) ? i : {},
                    o = !1,
                    r[e] = pt.extend(u, s, n)) : void 0 !== n && (r[e] = n));
        return r
    }
    ,
    pt.extend({
    ...
    var gt = function(t) {
        function e(t, e, i, n) {
            ...
            z)) {
                ...
                if (x.qsa && !U[t + " "] && (!N || !N.test(t)) && (1 !== p || "object" !== e.nodeName.toLowerCase())) {
                    ...
                    try {
                        return J.apply(i, d.querySelectorAll(c)),
                        i
                    } catch (e) {
                        U(t, !0)
                    } finally {
        ...
        function p(t, e, i) {
            ...
            : function(e, i, l) {
                ...
                if (l) {
                    ...
                    for (; e = e[n]; )
                        if (1 === e.nodeType || r)
                            if (c = (h = e[O] || (e[O] = {}))[e.uniqueID] || (h[e.uniqueID] = {}),
        ...
        var b, x, S, w, T, C, _, E, k, I, P, D, A, L, z, N, M, j, W, O = "sizzle" + 1 * new Date, q = t.document, $ = 0, H = 0, R = i(), B = i(), F = i(), U = i(), V = function(t, e) {
            ...
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, tt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", et = "[\\x20\\t\\r\\n\\f]", it = "(?:\\\\[\\da-fA-F]{1,6}" + et + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", nt = "\\[" + et + "*(" + it + ")(?:" + et + "*([*^$|!~]?=)" + et + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + it + "))|)" + et + "*\\]", ot = ":(" + it + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + nt + ")*)|.*)\\)|)", st = new RegExp(et + "+","g"), rt = new RegExp("^" + et + "+|((?:^|[^\\\\])(?:\\\\.)*)" + et + "+$","g"), at = new RegExp("^" + et + "*," + et + "*"), lt = new RegExp("^" + et + "*([>+~]|" + et + ")" + et + "*"), ut = new RegExp(et + "|>"), ct = new RegExp(ot), ht = new RegExp("^" + it + "$"), dt = {
            ID: new RegExp("^#(" + it + ")"),
            CLASS: new RegExp("^\\.(" + it + ")"),
            TAG: new RegExp("^(" + it + "|[*])"),
            ATTR: new RegExp("^" + nt),
        ...
        (S = e.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return dt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && ct.test(i) && (e = C(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
                ...
                CHILD: function(t, e, i, n, o) {
                    ...
                    : function(e, i, l) {
                        ...
                        if (m) {
                            ...
                            r && y) {
                                for (b = (f = (u = (c = (h = (d = m)[O] || (d[O] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] || [])[0] === $ && u[1]) && u[2],
                                d = f && m.childNodes[f]; d = ++f && d && d[g] || (b = f = 0) || p.pop(); )
                                    if (1 === d.nodeType && ++b && d === e) {
                                        c[t] = [$, f, b];
                                        break
                                    }
                            } else if (y && (b = f = (u = (c = (h = (d = e)[O] || (d[O] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] || [])[0] === $ && u[1]),
                            !1 === b)
                                for (; (d = ++f && d && d[g] || (b = f = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && ((c = (h = d[O] || (d[O] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] = [$, b]),
                                d !== e)); )
                                    ;
        ...
        C = e.tokenize = function(t, i) {
            ...
            u = S.preFilter; a; ) {
                ...
                a = a.slice(n.length)),
                S.filter)
                    !(o = dt[r].exec(a)) || u[r] && !(o = u[r](o)) || (n = o.shift(),
                    s.push({
                        value: n,
                        type: r,
                        matches: o
            ...
            if (!d) {
                ...
                u = function(t, i, n, o, u) {
                    ...
                    a && p !== f) {
                        ...
                        J.apply(o, v),
                        u && !t && 0 < v.length && 1 < f + r.length && e.uniqueSort(o)
                    }
                    return u && ($ = x,
                    k = y),
                    g
        ...
        E = e.select = function(t, e, i, n) {
            ...
            return (u || _(t, c))(n, e, !z, i, !e || yt.test(t) && h(e.parentNode) || e),
            i
        }
        ,
    ...
    (pt.fn.init = function(t, e, i) {
        ...
        this.length = 1,
        this) : ut(t) ? void 0 !== i.ready ? i.ready(t) : t(pt) : pt.makeArray(t, this)
    }
    ).prototype = pt.fn,
    xt = pt(ht);
        ...
        var o, s, r, a, l = [], u = [], c = -1, h = function() {
            ...
            r = o = !0; u.length; c = -1)
                for (s = u.shift(); ++c < l.length; )
                    !1 === l[c].apply(s[0], s[1]) && t.stopOnFalse && (c = l.length,
                    s = !1);
            t.memory || (s = !1),
            o = !1,
            a && (l = s ? [] : "")
    ...
    pt.extend({
                            ...
                            var a = this
                              ...
                              , h = function() {
                                ...
                                if (!(e < r)) {
                                    ...
                                    ut(h) ? o ? h.call(t, s(r, i, l, o), s(r, i, u, o)) : (r++,
                                    h.call(t, s(r, i, l, o), s(r, i, u, o), s(r, i, l, i.notifyWith))) : (n !== l && (a = void 0,
                                    c = [t]),
                                    (o || i.resolveWith)(a, c))
                                }
                            }
        ...
        when: function(t) {
            ...
            if (e <= 1 && (c(t, s.done(r(i)).resolve, s.reject, !e),
    ...
    pt.event = {
            ...
            if (m && (l = m.events)) {
                for (u = (e = (e || "").match(Ct) || [""]).length; u--; )
                    ...
                    f) {
                        ...
                        r = s = d.length; s--; )
                            c = d[s],
                            !o && g !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (d.splice(s, 1),
        ...
        dispatch: function(t) {
            ...
            !c.preDispatch || !1 !== c.preDispatch.call(this, l)) {
                for (r = pt.event.handlers.call(this, l, u),
            ...
            if (l && u.nodeType && !("click" === t.type && 1 <= t.button))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== t.type || !0 !== u.disabled)) {
                        ...
                        r = {},
                        i = 0; i < l; i++)
                            void 0 === r[o = (n = e[i]).selector + " "] && (r[o] = n.needsContext ? -1 < pt(o, this).index(u) : pt.find(o, this, null, [u]).length),
                            r[o] && s.push(n);
                        s.length && a.push({
                            elem: u,
                            handlers: s
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return Ut.test(e.type) && e.click && s(e, "input") && _(e, "click", S),
                    !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return Ut.test(e.type) && e.click && s(e, "input") && _(e, "click"),
                    !0
                },
                _default: function(t) {
                    var e = t.target;
        ...
        clone: function(t, e, i) {
            ...
            if (!(lt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || pt.isXMLDoc(t)))
                ...
                o = (s = y(t)).length; n < o; n++)
                    a = s[n],
                    l = r[n],
                    "input" === (u = l.nodeName.toLowerCase()) && Ut.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (e)
                if (i)
                    for (s = s || y(t),
                    r = r || y(c),
                    ...
                    P(t, c);
            return 0 < (r = y(c, "script")).length && b(r, !h && y(t, "script")),
            c
        },
    ...
    pt.each(["height", "width"], function(t, e) {
        pt.cssHooks[e] = {
            get: function(t, i, n) {
                if (i)
                    return !ae.test(pt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? W(t, e, n) : ie(t, ue, function() {
                        return W(t, e, n)
                    })
            },
            set: function(t, i, n) {
    ...
    pt.Animation = pt.extend(B, {
        ...
        prefilters: [function(t, e, i) {
            ...
            if ((l = !pt.isEmptyObject(e)) || !pt.isEmptyObject(f))
                ...
                "none" === (c = pt.css(t, "display")) && (u ? c = u : (v([t], !0),
                u = t.style.display || u,
                c = pt.css(t, "display"),
                v([t]))),
    ...
    pt.fn.extend({
        val: function(t) {
            var e, i, n, o = this[0];
            return arguments.length ? (n = ut(t),
        ...
        trigger: function(e, i, n, o) {
            ...
            o || !h.trigger || !1 !== h.trigger.apply(n, i))) {
                ...
                for (s = 0; (r = f[s++]) && !e.isPropagationStopped(); )
                    ...
                    (c = u && r[u]) && c.apply && Dt(r) && (e.result = c.apply(r, i),
                    !1 === e.result && e.preventDefault());
                return e.type = p,
                o || e.isDefaultPrevented() || h._default && !1 !== h._default.apply(f.pop(), i) || !Dt(n) || u && ut(n[p]) && !ct(n) && ((a = n[u]) && (n[u] = null),
    ...
    pt.extend({
        ...
        ajax: function(e, i) {
            function n(e, i, n, a) {
                ...
                u ? (p.ifModified && ((S = T.getResponseHeader("Last-Modified")) && (pt.lastModified[s] = S),
            ...
            var o, s, r, a, l, u, c, h, d, f, p = pt.ajaxSetup({}, i), g = p.context || p, m = p.context && (g.nodeType || g.jquery) ? pt(g) : pt.event, v = pt.Deferred(), y = pt.Callbacks("once memory"), b = p.statusCode || {}, x = {}, S = {}, w = "canceled", T = {
                ...
                setRequestHeader: function(t, e) {
                    return null == c && (t = S[t.toLowerCase()] = S[t.toLowerCase()] || t,
                    x[t] = e),
                    this
                },
            ...
            p.data && (p.processData || "string" == typeof p.data) && (s += (Ee.test(s) ? "&" : "?") + p.data,
            delete p.data),
    ...
    pt.fn.extend({
        wrapAll: function(t) {
            var e;
            return this[0] && (ut(t) && (t = t.call(this[0])),
    ...
    pt.ajaxPrefilter("json jsonp", function(e, i, n) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
            return o = e.jsonpCallback = ut(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
    ...
    pt.offset = {
        setOffset: function(t, e, i) {
            ...
            s = pt.css(t, "top"),
            l = pt.css(t, "left"),
            ("absolute" === u || "fixed" === u) && -1 < (s + l).indexOf("auto") ? (r = (n = c.position()).top,
    ...
    pt.each({
        ...
        pt.fn[t] = function(n) {
            return kt(this, function(t, n, o) {
                var s;
                if (ct(t) ? s = t : 9 === t.nodeType && (s = t.defaultView),
                void 0 === o)
                    return s ? s[e] : t[n];
        ...
        pt.each({
            ...
            pt.fn[n] = function(o, s) {
                ...
                return kt(this, function(e, i, o) {
                    var s;
                    return ct(e) ? 0 === n.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (s = e.documentElement,
    ...
    T4SThemeSP.Carousel = function() {
        function e(e) {
            ...
            setTimeout(function() {
                ...
                c.args.isSimple && (c.actionsAPI("resize"),
        ...
        return e.prototype = Object.assign({}, e.prototype, {
            ...
            _status: function() {
                function e() {
                    void 0 != n.flkty.slides && (u = n.flkty.selectedIndex + 1,
...
https://demo-kalles-4-1.myshopify.com/cdn/shop/t/2/assets/global.min.js?v=38540426977691419761732846614