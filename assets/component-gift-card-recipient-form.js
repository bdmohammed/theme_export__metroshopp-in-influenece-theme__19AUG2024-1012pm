  ...
  (() => {
    ...
    class GiftCardRecipientForm extends HTMLElement {
      constructor() {
        ...
        this.giftCardRecipientsFields = this.querySelectorAll(
          '[name*="Recipient"]',
        );
        this.giftCardRecipientFieldContainer = this.querySelector(
          ".gift_card_recipient_fields",
        );
      }
      ...
      init() {
        ...
        this.toggleCheckbox.addEventListener(
          "change",
          this.toggleFormVisibility.bind(this),
        );
        window.eight.armada.elementRegistry.register({
          key: "gift-card-recipient-form",
          assetPath: "/assets/component-gift-card-recipient-form.min.js",
        });
      }
      ...
      hideGiftCardRecipientForm() {
        ...
        this.giftCardRecipientFieldContainer.classList.add(
          "invisible",
          "opacity-0",
        );
      }
      ...
      disableGiftCardRecipientsFields() {
        this.giftCardRecipientsFields.forEach(
      ...
      expandGiftCardRecipientFieldContainer() {
        if (!this.animate) return;
        const openHeight =
          this.offsetHeight + this.giftCardRecipientFieldContainer.offsetHeight;
        this.style.height = `${openHeight}px`;
      }

      showGiftCardRecipientForm() {
        this.giftCardRecipientFieldContainer.classList.remove(
          "invisible",
          "opacity-0",
        );
      ...
      detachEvents() {
        this.toggleCheckbox.removeEventListener(
          "change",
          this.toggleFormVisibility.bind(this),
        );
      }
