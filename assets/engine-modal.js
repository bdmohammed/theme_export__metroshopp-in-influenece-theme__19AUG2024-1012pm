  ...
  (() => {
    ...
    `;
      ...
      init() {
        ...
        if (this.themeEditorOnly && window.Shopify.designMode) {
          ...
          document.addEventListener("shopify:block:deselect", (e) =>
            this.editorCloseHandler(e, e.detail.blockId, true),
          );
          document.addEventListener("shopify:section:select", (e) =>
            this.sectionSelectHandler(e),
          );
          document.addEventListener("shopify:section:deselect", (e) =>
            this.editorCloseHandler(e, e.detail.sectionId, false),
          );
        }
      ...
      blockSelectHandler(e) {
        ...
        const sectionModal = this.parentElement.querySelector(
      ...
      handleOpen(id) {
        ...
        if (this.modalSection) {
          const modalContentWrapper = this.querySelector(
      ...
      buildModal() {
        ...
        const modalContainer = new DOMParser()
        ...
        if (this.isDismissable) {
          const modalHeader = this.querySelector(
          ...
          const closeButton = new DOMParser()
        ...
        const closeElements = this.querySelectorAll(
          "[data-armada-modal-close]",
        );
        ...
        if (this.modalUnderlayClasses) {
          const underlay = this.querySelector(
      ...
      removeTransitionClasses() {
        const modalInner = this.querySelector(
