  ...
  (() => {
    ...
    class ScrollBar extends HTMLElement {
      ...
      connectedCallback() {
        ...
        this.dataset.target = this.dataset.target
          ? this.dataset.target
          : "scrollbar-target";
        this.dataset.navLeft = this.dataset.navLeft
          ? this.dataset.navLeft
          : "icon-prev";
        this.dataset.navRight = this.dataset.navRight
        ...
        this.target = this.parent.querySelector(
          `[data-name="${this.dataset.target}"]`,
        );
        this.navLeft = this.parent.querySelector(
          `[data-name="${this.dataset.navLeft}"]`,
        );
        this.navRight = this.parent.querySelector(
          `[data-name="${this.dataset.navRight}"]`,
        );

        if (!this.target) {
          console.warn(
            "Could not find scrollbar target",
            this.dataset.target,
            "in",
            this.parent,
          );
      ...
      setEventListeners() {
        ...
        if (this.navLeft)
          this.navLeft.addEventListener(
            "click",
            this.decreaseProgress.bind(this),
          );
        if (this.navRight)
          this.navRight.addEventListener(
            "click",
