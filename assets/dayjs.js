  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      var i = function (t, e, n) {
          ...
          return !o || o.length >= e
            ? t
            : "".concat(Array(e + 1 - o.length).join(n)).concat(t);
        },
        s = function (t) {
          var e = Math.abs(t),
            n = Math.floor(e / 60),
              ...
              value: function () {
                var t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : this.$timezoneOffset;
                this.$d.setTime(this.$d.getTime() + c(this.$timezoneOffset, t)),
      ...
      [
        ...
        [
          ...
          l.prototype[t] = function () {
            return a[t].apply(
              new Date(this.$d.getTime() + c(this.$timezoneOffset)),
              arguments,
            );
          };
        }),
        [
          ...
          l.prototype[t] = function () {
            ...
            a[t].apply(e, arguments),
              e.setTime(e.getTime() - c(this.$timezoneOffset)),
              (this.$d = e);
          };
        }),
        ["toString", "toTimeString"].forEach(function (t) {
          l.prototype[t] = function () {
            return a[t]
              ...
              .replace(/GMT(.*)$/, "GMT".concat(s(this.$timezoneOffset)));
          };
        });
      var d = l,
        p = !1,
        h = function (t, e) {
          ["clone", "add", "subtract", "startOf"].forEach(function (n) {
            ...
            (t.utcOffset = function (t) {
              ...
              return (
                null !== r(t) &&
                  (this.$d.setTimezoneOffset(-r(t)), this.init()),
                this
              );
            }),
            (t.toDate = function () {
