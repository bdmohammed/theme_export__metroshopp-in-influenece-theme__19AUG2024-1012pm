...
/******/ (() => {
  ...
  (() => {
    ...
    class NavigationItem extends HTMLElement {
      constructor() {
        super();
        this.detailsElement = this.querySelector(
          '[data-armada-selector="navigation-item-details"]',
        );
        this.summaryElement = this.querySelector(
          '[data-armada-selector="navigation-item-summary"]',
        );
        this.navItems = this.querySelectorAll(
          '[data-armada-selector="navigation-item-link"]',
        );
        this.dropdown = this.querySelector(
          '[data-armada-selector="navigation-item-dropdown"]',
        );
        this.visualNav = this.querySelector(
          '[data-armada-selector="navigation-item-visual"]',
        );
        this.forceOpenDropdown = false;
        this.templateContent = this.querySelector("template").content;
        this.templateDrawer = this.templateContent.querySelector(
      ...
      attachEvents() {
        ...
        document.addEventListener(
          ...
          this.closeNavDropdown.bind(this),
        );
        document.addEventListener(
          "ARMADA:NAVIGATION:MOBILE:CLOSE",
          this.closeAllDrawers.bind(this),
        );
      ...
      themeEditorHideBlocks() {
        ...
        const forcedOpen = document.querySelectorAll(
      ...
      buildNestedDrawer(navItem) {
        ...
        const childLinkList = navItem.querySelector(
          '[data-armada-selector="navigation-item-children"]',
        );

        // Build nested drawer for each grandchild link list
        const childLinks = navItem.querySelectorAll(
          '[data-armada-selector="navigation-item-child-link"]',
        );
        ...
        // Set drawer id and close button text
        const openBtn = navItem.querySelector(
      ...
      setAriaAttributes() {
        const openBtns = this.querySelectorAll(
          '[data-armada-selector="navigation-item-summary"], [data-armada-selector="navigation-item-parent"]',
        );
      ...
      closeAllDrawers() {
        const drawers = this.querySelectorAll(
          '[data-armada-selector="navigation-item-drawer"]',
        );
